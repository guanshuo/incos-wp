...
RUN apt-get install -y build-essential g++-4.4 curl wget git unzip libpcre3 libpcre3-dev openssl libssl-dev make python-software-properties python-setuptools openssh-server software-properties-common debian-archive-keyring gcc
...
RUN cd n2n-master/n2n_v2/ && make && make install
