...
RUN apt-get install -y libpcre3 libpcre3-dev make gcc g++ build-essential cmake curl wget git unzip python-software-properties python-setuptools software-properties-common debian-archive-keyring libssl-dev openssl openssh-server
...
# Install n2n
ADD https://github.com/meyerd/n2n/archive/master.zip .
RUN unzip master.zip && cd /n2n-master/n2n_v2 && cmake ./ && make && make install
...
VOLUME ["/data"]
EXPOSE 22 80 3306 8080 9001 11211
