...
RUN apt-get install -y gcc-c++ curl wget git unzip libpcre3 libpcre3-dev openssl libssl-dev make python-software-properties python-setuptools openssh-server software-properties-common debian-archive-keyring gcc
