...
RUN apt-get install -y build-essential curl wget git unzip libpcre3 libpcre3-dev openssl libssl-dev make python-software-properties python-setuptools openssh-server software-properties-common debian-archive-keyring gcc
...
RUN unzip master.zip && cd n2n-master/n2n_v2/ && make && make install
